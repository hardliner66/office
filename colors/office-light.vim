" office-light, a vim colourscheme by haystackandroid
"
...
if has('nvim')
  ...
  let g:terminal_color_15 = '#2b2b29'
endif
...
if filereadable(expand('~/.nightshell/office-light'))
  if !has('gui_running')
...
if exists('g:office_light_CursorLineNr')
if g:office_light_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:office_light_LineNr')
if g:office_light_LineNr == 'off'
